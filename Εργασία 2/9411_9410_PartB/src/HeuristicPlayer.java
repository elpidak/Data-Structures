...
//vBapples αντιστοιχουν στα στατιστικα στοιχεια του παιχνιδιου για τον παικτη.
	...
	void statistics() {	
		...
		System.out.println("Episkepseis se plakidio me kefali fidiou: " + vSnakes + "\nEpiskepseis se plakidio me vash skalas: " + vLadders + " \nEpiskepseis se plakidio me kokkino mhlo: " + vRapples +
